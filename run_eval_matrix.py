...
from automechinterp.behaviors import ALL_BEHAVIORS
...
def main() -> int:
    ...
    ap.add_argument("--ai-judge", choices=["openai", "anthropic"], default=None,
                    help="also RubricJudge-score every report (needs the matching API key)")
    ...
    behaviors = ALL_BEHAVIORS[: args.behaviors] if args.behaviors else None
        ...
        try:
            if args.check:
                ...
                result = run_stage_d(
                    ...
                    ai_judge_backend=args.ai_judge,
                    is_part_of_scaling_sweep=True,
