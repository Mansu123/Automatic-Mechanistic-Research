...
def build_probe_agent(handle: adapter.ModelHandle, layer_idx: int,
    ...
    def do_causal():
        ...
        state["probe_direction_causal_test"] = r
        return digest_dict(r)
    ...
    def policy_fn(evidence_text: str, tool_menu: list[str]) -> dict:
        ...
        if state["linear_probe"].get("status") == "insufficient_data":
            return {"action":"stop", "reasoning":"insufficient training data; probe quality unmeasured"}
