...
Usage:
    ...
    python3 main.py --stage-d                 # write one report per behavior to
                                               # human_review/reports/ for scoring against the
                                               # shared 8-metric rubric (matrix_rubric.py)
...
def main():
    ...
    parser.add_argument("--stage-d", action="store_true",
                         help="run Stage D: evaluation pipeline -- writes one report per behavior to "
                              "human_review/reports/ for scoring against the shared 8-metric rubric "
                              "(matrix_rubric.py), instead of Stage A, and exit")
...
def _run_stage_d(backend_kind: str, target_model_id: str):
